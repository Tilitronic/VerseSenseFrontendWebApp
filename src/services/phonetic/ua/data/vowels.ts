...
export default {
  ...
  phonemes: [
    { ipa: 'i',  cyrillic: 'і',  height: 'high',     backness: 'front', rounding: 'unrounded', stable: true  },
    { ipa: 'ɪ',  cyrillic: 'и',  height: 'high-mid', backness: 'front', rounding: 'unrounded', stable: false },
    { ipa: 'ɛ',  cyrillic: 'е',  height: 'mid',      backness: 'front', rounding: 'unrounded', stable: false },
    { ipa: 'u',  cyrillic: 'у',  height: 'high',     backness: 'back',  rounding: 'rounded',   stable: true  },
    { ipa: 'ɔ',  cyrillic: 'о',  height: 'mid',      backness: 'back',  rounding: 'rounded',   stable: false },
    { ipa: 'ɑ',  cyrillic: 'а',  height: 'low',      backness: 'back',  rounding: 'unrounded', stable: true  },
  ],
  allophones: {
    ...
    rules: [
      ...
      },
      {
        ...
        allophone: 'ɔ̝',
        description: 'Unstressed /о/ before stressed /у/ or /і/ narrows toward [у], transcribed [оу]',
      },
    ],
  },
  iotatedVowels: {
